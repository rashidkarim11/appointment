...
function AppointmentPage() {
  return (
    <div className="px-8 mt-8 text-[poppins]">
      ...
      <form className="bg-blue-400 py-10 mx-auto text-center mt-4 border-none border-gray-700 sm:w-3/4 md:w-2/4 lg:w-5/4 py-16">
        <div className="mb-4 flex flex-col px-10">
          ...
          <input
            ...
            required
            className="border-none rounded border-gray-700 py-2 mt-2"
          />
        </div>
        <div className="mb-4 flex flex-col px-10">
          <label className="text-left">
        ...
        <button
          type="submit"
          className="border-none bg-white rounded border-gray-700 px-4 py-2 mt-2"
        >
          Submit
        </button>
      </form>
